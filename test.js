...
describe('mergeDeep', function() {
  it('should merge object properties without affecting any object', function() {
    ...
    assert.deepEqual(merge(merge(obj1, obj2), obj3), {a: 4, b: 1, c: 2, d: 5 });
    assert.deepEqual(obj1, {a: 0, b: 1});
    assert.deepEqual(obj2, {c: 2, d: 3});
    assert.deepEqual(obj3, {a: 4, d: 5});
  });
  ...
  it('should not merge strings', function() {
    ...
    var obj2 = {a: {b: 2, d: {f: 'f'} }};
    var obj3 = {a: 'bar'};
    var actual = merge(merge(obj1, obj2), obj3);
